import { a4 as S, a7 as F, aH as U, _ as p, g as j, s as q, a as Z, b as J, q as K, p as Q, l as z, c as X, D as Y, H as ee, N as te, e as ae, y as re, F as ne } from "./mermaid.core-D5rUg3ka.js";
import { p as ie } from "./chunk-4BX2VUAB-Dj3mPi-D.js";
import { p as se } from "./mermaid-parser.core-fKU7dWXj.js";
import { d as I } from "./arc-DcArfcfZ.js";
...
function ue() {
  ...
  function l(t) {
    var n, c = (t = U(t)).length, g, x, m = 0, u = new Array(c), i = new Array(c), v = +y.apply(this, arguments), w = Math.min(F, Math.max(-F, s.apply(this, arguments) - v)), h, C = Math.min(Math.abs(w) / c, o.apply(this, arguments)), $ = C * (w < 0 ? -1 : 1), d;
    for (n = 0; n < c; ++n)
...
` + e);
  ...
  const O = [...d.entries()].map(([r, M]) => ({
    ...
    const R = n + c, B = R * O.length / 2, V = 12 * n, H = M * R - B;
