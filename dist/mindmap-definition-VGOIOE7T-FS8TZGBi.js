import { g as ae } from "./chunk-55IACEB6-Bdrvodal.js";
import { s as oe } from "./chunk-QN33PNHL-BfsBTpvT.js";
import { _ as c, l as C, o as ce, r as le, F as V, c as z, i as B, af as he, W as ge, X as de, Y as ue } from "./mermaid.core-D5rUg3ka.js";
import { v as pe } from "./lib-D0JJqd6q.js";
var X = (function() {
  var r = /* @__PURE__ */ c(function(x, s, t, a) {
    for (t = t || {}, a = x.length; a--; t[x[a]] = s) ;
    return t;
  }, "o"), e = [1, 4], i = [1, 13], l = [1, 12], p = [1, 15], h = [1, 16], u = [1, 20], y = [1, 19], E = [6, 7, 8], _ = [1, 26], m = [1, 24], R = [1, 25], S = [6, 7, 11], Y = [1, 6, 13, 15, 16, 19, 22], q = [1, 33], J = [1, 34], A = [1, 6, 7, 11, 13, 15, 16, 19, 22], G = {
    ...
    performAction: /* @__PURE__ */ c(function(s, t, a, o, d, n, w) {
      var g = n.length - 1;
      switch (d) {
        case 6:
        case 7:
    ...
    table: [{ 3: 1, 4: 2, 5: 3, 6: [1, 5], 8: e }, { 1: [3] }, { 1: [2, 1] }, { 4: 6, 6: [1, 7], 7: [1, 8], 8: e }, { 6: i, 7: [1, 10], 9: 9, 12: 11, 13: l, 14: 14, 15: p, 16: h, 17: 17, 18: 18, 19: u, 22: y }, r(E, [2, 3]), { 1: [2, 2] }, r(E, [2, 4]), r(E, [2, 5]), { 1: [2, 6], 6: i, 12: 21, 13: l, 14: 14, 15: p, 16: h, 17: 17, 18: 18, 19: u, 22: y }, { 6: i, 9: 22, 12: 11, 13: l, 14: 14, 15: p, 16: h, 17: 17, 18: 18, 19: u, 22: y }, { 6: _, 7: m, 10: 23, 11: R }, r(S, [2, 22], { 17: 17, 18: 18, 14: 27, 15: [1, 28], 16: [1, 29], 19: u, 22: y }), r(S, [2, 18]), r(S, [2, 19]), r(S, [2, 20]), r(S, [2, 21]), r(S, [2, 23]), r(S, [2, 24]), r(S, [2, 26], { 19: [1, 30] }), { 20: [1, 31] }, { 6: _, 7: m, 10: 32, 11: R }, { 1: [2, 7], 6: i, 12: 21, 13: l, 14: 14, 15: p, 16: h, 17: 17, 18: 18, 19: u, 22: y }, r(Y, [2, 14], { 7: q, 11: J }), r(A, [2, 8]), r(A, [2, 9]), r(A, [2, 10]), r(S, [2, 15]), r(S, [2, 16]), r(S, [2, 17]), { 20: [1, 35] }, { 21: [1, 36] }, r(Y, [2, 13], { 7: q, 11: J }), r(A, [2, 11]), r(A, [2, 12]), { 21: [1, 37] }, r(S, [2, 25]), r(S, [2, 27])],
    ...
    parse: /* @__PURE__ */ c(function(s) {
      var t = this, a = [0], o = [], d = [null], n = [], w = this.table, g = "", M = 0, K = 0, ie = 2, Q = 1, se = n.slice.call(arguments, 1), f = Object.create(this.lexer), v = { yy: {} };
      for (var j in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, j) && (v.yy[j] = this.yy[j]);
      f.setInput(s, v.yy), v.yy.lexer = f, v.yy.parser = this, typeof f.yylloc > "u" && (f.yylloc = {});
      var $ = f.yylloc;
      n.push($);
      var ne = f.options && f.options.ranges;
      typeof v.yy.parseError == "function" ? this.parseError = v.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function re(N) {
        a.length = a.length - 2 * N, d.length = d.length - N, n.length = n.length - N;
      }
      c(re, "popStack");
      function Z() {
        var N;
        return N = o.pop() || f.lex() || Q, typeof N != "number" && (N instanceof Array && (o = N, N = o.pop()), N = t.symbols_[N] || N), N;
      }
      c(Z, "lex");
      for (var b, T, D, H, O = {}, F, k, ee, U; ; ) {
        if (T = a[a.length - 1], this.defaultActions[T] ? D = this.defaultActions[T] : ((b === null || typeof b > "u") && (b = Z()), D = w[T] && w[T][b]), typeof D > "u" || !D.length || !D[0]) {
          var W = "";
          U = [];
          for (F in w[T])
            this.terminals_[F] && F > ie && U.push("'" + this.terminals_[F] + "'");
          f.showPosition ? W = "Parse error on line " + (M + 1) + `:
` + f.showPosition() + `
Expecting ` + U.join(", ") + ", got '" + (this.terminals_[b] || b) + "'" : W = "Parse error on line " + (M + 1) + ": Unexpected " + (b == Q ? "end of input" : "'" + (this.terminals_[b] || b) + "'"), this.parseError(W, {
            text: f.match,
        ...
        if (D[0] instanceof Array && D.length > 1)
          throw new Error("Parse Error: multiple actions possible at state: " + T + ", token: " + b);
        switch (D[0]) {
          case 1:
            a.push(b), d.push(f.yytext), n.push(f.yylloc), a.push(D[1]), b = null, K = f.yyleng, g = f.yytext, M = f.yylineno, $ = f.yylloc;
            break;
          case 2:
            if (k = this.productions_[D[1]][1], O.$ = d[d.length - k], O._$ = {
              first_line: n[n.length - (k || 1)].first_line,
              last_line: n[n.length - 1].last_line,
              first_column: n[n.length - (k || 1)].first_column,
              last_column: n[n.length - 1].last_column
            }, ne && (O._$.range = [
              n[n.length - (k || 1)].range[0],
              ...
              d,
              n
            ].concat(se)), typeof H < "u")
              return H;
            k && (a = a.slice(0, -1 * k * 2), d = d.slice(0, -1 * k), n = n.slice(0, -1 * k)), a.push(this.productions_[D[1]][0]), d.push(O.$), n.push(O._$), ee = w[a[a.length - 2]][a[a.length - 1]], a.push(ee);
            break;
          case 3:
            return !0;
        }
...
` + this.showPosition(), {
  ...
  return c(P, "Parser"), P.prototype = G, G.Parser = P, new P();
})();
X.parser = X;
var fe = X, L = {
  DEFAULT: 0,
  ...
  addNode(e, i, l, p) {
    ...
    const E = {
      ...
      type: p,
      children: [],
      width: ((R = u.mindmap) == null ? void 0 : R.maxNodeWidth) ?? V.mindmap.maxNodeWidth,
      padding: y,
      isRoot: h
    }, _ = this.getParent(e);
    if (_)
      _.children.push(E), this.nodes.push(E);
    else if (h)
      this.nodes.push(E);
    else
      throw new Error(
  ...
  getType(e, i) {
    switch (C.debug("In get type", e, i), e) {
      case "[":
  ...
  decorateNode(e) {
    if (!e)
      return;
    const i = z(), l = this.nodes[this.nodes.length - 1];
    e.icon && (l.icon = B(e.icon, i)), e.class && (l.class = B(e.class, i));
  }
  type2Str(e) {
    switch (e) {
  ...
  assignSections(e, i) {
    if (e.level === 0 ? e.section = void 0 : e.section = i, e.children)
      for (const [l, p] of e.children.entries()) {
        const h = e.level === 0 ? l : i;
        this.assignSections(p, h);
      }
  }
  /**
  ...
  generateEdges(e, i) {
    if (e.children)
      for (const l of e.children) {
        let p = "edge";
        l.section !== void 0 && (p += ` section-edge-${l.section}`);
        const h = e.level + 1;
        p += ` edge-depth-${h}`;
        const u = {
        ...
        i.push(u), this.generateEdges(l, i);
      }
  }
  /**
   ...
   */
  getData() {
    const e = this.getMindmap(), i = z(), p = he().layout !== void 0, h = i;
    if (p || (h.layout = "cose-bilkent"), !e)
      return {
        nodes: [],
        edges: [],
        config: h
      };
    C.debug("getData: mindmapRoot", e, i), this.assignSections(e);
    const u = [], y = [];
    this.flattenNodes(e, u), this.generateEdges(e, y), C.debug(
      `getData: processed ${u.length} nodes and ${y.length} edges`
    );
...
}, c(I, "MindmapDB"), I), me = /* @__PURE__ */ c(async (r, e, i, l) => {
  var E, _;
  C.debug(`Rendering mindmap diagram
` + r);
  const p = l.db, h = p.getData(), u = ae(e, h.config.securityLevel);
  h.type = l.type, h.layoutAlgorithm = ce(h.config.layout, {
    fallback: "cose-bilkent"
  }), h.diagramId = e, p.getMindmap() && (h.nodes.forEach((m) => {
    ...
    u,
    ((E = h.config.mindmap) == null ? void 0 : E.padding) ?? V.mindmap.padding,
    "mindmapDiagram",
    ((_ = h.config.mindmap) == null ? void 0 : _.useMaxWidth) ?? V.mindmap.useMaxWidth
  ));
}, "draw"), Ee = {
  draw: me
}, _e = /* @__PURE__ */ c((r) => {
