import { _ as V, l as k, d as lt } from "./mermaid.core-BwFqOkFz.js";
import { c as tt } from "./cytoscape.esm-CjI2IsL8.js";
import { g as gt } from "./lib-CdvQKKC3.js";
        ...
        (function(N) {
          ...
          (function(N, I, T) {
            ...
            h.prototype.getNodes = function() {
              ...
              for (var v = e.MAX_VALUE, D = -e.MAX_VALUE, u = e.MAX_VALUE, E = -e.MAX_VALUE, y, O, s, f, c, L = this.nodes, A = L.length, m = 0; m < A; m++) {
                var C = L[m];
                p && C.child != null && C.updateBounds(), y = C.getLeft(), O = C.getRight(), s = C.getTop(), f = C.getBottom(), v > y && (v = y), D < O && (D = O), u > s && (u = s), E < f && (E = f);
              }
              var R = new n(v, u, D - v, E - u);
              v == e.MAX_VALUE && (this.left = this.parent.getLeft(), this.right = this.parent.getRight(), this.top = this.parent.getTop(), this.bottom = this.parent.getBottom()), L[0].getParent().paddingLeft != null ? c = L[0].getParent().paddingLeft : c = this.margin, this.left = R.x - c, this.right = R.x + R.width + c, this.top = R.y - c, this.bottom = R.y + R.height + c;
          ...
          (function(N, I, T) {
            ...
            e.calcSeparationAmount = function(t, i, l, g) {
              ...
              var h = t.getX(), a = t.getY(), p = t.getRight(), v = t.getX(), D = t.getBottom(), u = t.getRight(), E = t.getWidthHalf(), y = t.getHeightHalf(), O = i.getX(), s = i.getY(), f = i.getRight(), c = i.getX(), L = i.getBottom(), A = i.getRight(), m = i.getWidthHalf(), C = i.getHeightHalf(), R = !1, M = !1;
              if (g === d) {
                if (n > r)
                ...
                if (-S === w ? g > d ? (l[0] = v, l[1] = D, R = !0) : (l[0] = p, l[1] = a, R = !0) : S === w && (g > d ? (l[0] = h, l[1] = a, R = !0) : (l[0] = u, l[1] = D, R = !0)), -Y === w ? d > g ? (l[2] = c, l[3] = L, M = !0) : (l[2] = f, l[3] = s, M = !0) : Y === w && (d > g ? (l[2] = O, l[3] = s, M = !0) : (l[2] = A, l[3] = L, M = !0)), R && M)
                  return !1;
        ...
        (function(I) {
          ...
          (function(I, T, o) {
            ...
            y.prototype.newGraphManager = function() {
              ...
              for (var f = new h(0, 0), c = Math.ceil(Math.sqrt(s.length)), L = 0, A = 0, m = 0, C = new a(0, 0), R = 0; R < s.length; R++) {
                R % c == 0 && (m = 0, A = L, R != 0 && (A += n.DEFAULT_COMPONENT_SEPERATION), L = 0);
                var M = s[R], S = p.findCenterOfTree(M);
                f.x = m, f.y = A, C = y.radialLayout(M, S, f), C.y > L && (L = Math.floor(C.y)), m = Math.floor(C.x + n.DEFAULT_COMPONENT_SEPERATION);
              }
              ...
              if (s.width - s.rowWidth[c] > m && f != c) {
                ...
                for (var C = Number.MIN_VALUE, R = 0; R < L.length; R++)
                  L[R].height > C && (C = L[R].height);
          ...
          (function(I, T, o) {
            ...
            a.prototype.run = function() {
              ...
              for (var L = 0; L < c.length; L++) {
                var A = c[L], m = this.idToLNode[A.data("source")], C = this.idToLNode[A.data("target")];
