import { aL as j, aM as p, aN as w, aO as q, aP as k } from "./mermaid.core-BwFqOkFz.js";
...
const V = R(g), $ = V.right;
R(O).center;
const x = Math.sqrt(50), L = Math.sqrt(10), T = Math.sqrt(2);
function v(n, r, t) {
  const e = (r - n) / Math.max(0, t), u = Math.floor(Math.log10(e)), f = e / Math.pow(10, u), a = f >= x ? 10 : f >= L ? 5 : f >= T ? 2 : 1;
  let o, c, i;
...
function d(n, r) {
  var t = typeof r, e;
  return r == null || t === "boolean" ? j(r) : (t === "number" ? p : t === "string" ? (e = k(r)) ? (r = e, w) : q : r instanceof k ? w : r instanceof Date ? K : H(r) ? G : Array.isArray(r) ? J : typeof r.valueOf != "function" && typeof r.toString != "function" || isNaN(r) ? Q : p)(n, r);
}
function U(n, r) {
