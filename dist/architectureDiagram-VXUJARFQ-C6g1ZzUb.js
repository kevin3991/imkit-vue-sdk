import { _ as dt, H as Ze, V as ke, l as Se, b as qe, a as Qe, p as Je, q as Ke, g as je, s as _e, y as tr, D as er, E as rr, F as ir, c as Ee, al as me, aI as pe, i as ar, d as nr, x as or, aJ as sr, aK as hr } from "./mermaid.core-D5rUg3ka.js";
import { p as lr } from "./chunk-4BX2VUAB-Dj3mPi-D.js";
import { p as fr } from "./mermaid-parser.core-fKU7dWXj.js";
import { c as Fe } from "./cytoscape.esm-CjI2IsL8.js";
import { g as cr } from "./lib-D0JJqd6q.js";
...
}, "isValidArchitectureDirectionPair"), ye = /* @__PURE__ */ dt(function(I, D) {
  const A = `${I}${D}`;
  return Lr(A) ? A : void 0;
}, "getArchitectureDirectionPair"), Cr = /* @__PURE__ */ dt(function([I, D], A) {
  const P = A[0], N = A[1];
...
}, "getArchitectureDirectionXYFactors"), Mr = /* @__PURE__ */ dt(function(I, D) {
...
}, dt(ae, "ArchitectureDB"), ae), xr = /* @__PURE__ */ dt((I, D) => {
...
`, "getStyles"), Rr = Ir, re = /* @__PURE__ */ dt((I) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${I}</g>`, "wrapIcon"), ne = {
...
}, Sr = /* @__PURE__ */ dt(async function(I, D, A) {
    ...
    D.edges().map(async (r) => {
      ...
      if (g && (Wt(f) ? T += f === "L" ? -G : G : d += f === "T" ? -G : G + 18), c && (Wt(o) ? S += o === "L" ? -G : G : C += o === "T" ? -G : G + 18), !g && ((K = A.getNode(e)) == null ? void 0 : K.type) === "junction" && (Wt(f) ? T += f === "L" ? u : -u : d += f === "T" ? u : -u), !c && ((X = A.getNode(t)) == null ? void 0 : X.type) === "junction" && (Wt(o) ? S += o === "L" ? u : -u : C += o === "T" ? u : -u), r[0]._private.rscratch) {
        ...
        if (Q.insert("path").attr("d", `M ${T},${d} L ${v},${L} L${S},${C} `).attr("class", "edge").attr("id", or(e, t, { prefix: "L" })), i) {
          ...
          Q.insert("polygon").attr("points", Ie[f](h)).attr("transform", `translate(${O},${rt})`).attr("class", "arrow");
        }
        if (s) {
          const O = Wt(o) ? se[o](S, h) : S - a, rt = qt(o) ? se[o](C, h) : C - a;
          Q.insert("polygon").attr("points", Ie[o](h)).attr("transform", `translate(${O},${rt})`).attr("class", "arrow");
        }
        if (l) {
          ...
          if (await me(
            ...
            const m = ye(f, o);
            if (m && Nr(m)) {
              const p = n.node().getBoundingClientRect(), [E, y] = Ar(m);
...
}, "drawEdges"), Fr = /* @__PURE__ */ dt(async function(I, D, A) {
    ...
    D.nodes().map(async (r) => {
      ...
      if (e.type === "group") {
        ...
        if (e.icon) {
          const T = s.append("g");
          T.html(
            `<g>${await pe(e.icon, { height: N, width: N, fallbackPrefix: ne.prefix })}</g>`
          ), T.attr(
            "transform",
...
}, "drawGroups"), br = /* @__PURE__ */ dt(async function(I, D, A) {
  const P = Ee();
  for (const N of A) {
  ...
  return 0;
}, "drawServices"), Pr = /* @__PURE__ */ dt(function(I, D, A) {
  A.forEach((P) => {
...
function Be(I, D, A, P, N, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    const r = nr("body").append("div").attr("id", "cy").attr("style", "display:none"), e = Fe({
...
var Gr = /* @__PURE__ */ dt(async (I, D, A, P) => {
  ...
  await Sr(i, o, N), await Fr(t, o, N), Xe(N, o), ke(void 0, f, N.getConfigField("padding"), N.getConfigField("useMaxWidth"));
}, "draw"), Ur = { draw: Gr }, zr = {
  parser: Ge,
  get db() {
    return new Pe();
